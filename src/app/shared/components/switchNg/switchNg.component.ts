...
@Component({
  selector: 'sica-switchNg',
  templateUrl: './switchNg.component.html',
  styleUrls: ['./switchNg.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SwitchNgComponent),
      multi: true
    }
  ]
})
export class SwitchNgComponent extends CustomFormControlComponent {
